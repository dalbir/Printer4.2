...
public class printer {
	...
	{
		PrintString24(EncodingUtils.getBytes(str, "GB2312"),0);
	}
	public void PrintString24Location(String str,int nleft)
	{
		PrintString24Location(EncodingUtils.getBytes(str, "GB2312"),nleft);
	}
	public void PrintString24Ex(String str,ArrangeType type)
	{
		...
		PrintString24(EncodingUtils.getBytes(str, "GB2312"),nArr);
	}	
